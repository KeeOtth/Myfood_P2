...
public class SerializacaoXML {
    ...
    /**
     * Serializa as informações do objeto no arquivo informado
     * @param objeto O objeto que deseja serializar
     * @param nome_arquivo O caminho onde os dados serão guardados
     */
...
//            System.out.println("Objetos de " + nome_arquivo + " foram serializados");
    ...
    /**
     * Desserializa as informações do arquivo informado no objeto
     * @param objeto Objeto onde serão guardados as informações
     * @param nome_arquivo O caminho onde os dados estão guardados
     * @return Retorna o objeto com as informações desserializadas
     */
